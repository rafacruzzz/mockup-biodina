...
interface SelecaoProdutoAtualizacaoStepProps {
  onSelecionarProduto: (produto: any, numeroRegistro: string) => void;
}

export const SelecaoProdutoAtualizacaoStep = ({ onSelecionarProduto }: SelecaoProdutoAtualizacaoStepProps) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 p-4 bg-gray-50 rounded-lg">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="relative">
            ...
            <Input
              placeholder="Código, Nome, Marca, Registro ANVISA..."
              value={busca}
        ...
        <div>
          ...
          <Input
            ...
            value={filtros.numeroRegistroAnvisa}
            onChange={(e) => setFiltros(prev => ({ ...prev, numeroRegistroAnvisa: e.target.value }))}
          />
        </div>
      ...
      <div className="text-sm text-gray-600">
        {produtosFiltrados.length} produto{produtosFiltrados.length !== 1 ? 's' : ''} com registro ANVISA encontrado{produtosFiltrados.length !== 1 ? 's' : ''}
      </div>
        ...
        {produtosFiltrados.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">
              Não há produtos com registro ANVISA que correspondam aos filtros aplicados.
            </p>
          </div>
        )}
      </div>
