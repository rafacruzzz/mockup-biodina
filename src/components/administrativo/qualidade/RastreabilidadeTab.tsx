...
import { BuscaPreditivaRegulatorio } from '../regulatorio/rastreabilidade/BuscaPreditivaRegulatorio';
import { DossieEquipamentoRegulatorio } from '../regulatorio/rastreabilidade/DossieEquipamentoRegulatorio';
        ...
        <Card className="border-dashed">
          <CardContent className="py-16">
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">Sistema de Rastreabilidade - Qualidade</h3>
