...
import { Package, AlertCircle, CheckCircle, Clock, Printer, Eye, Calendar, MapPin, MessageSquare } from "lucide-react";
        ...
        <DialogContent className="max-w-7xl max-h-[90vh] overflow-y-auto">
          ...
          <Tabs defaultValue="separacao" className="w-full">
            ...
            <TabsContent value="historico" className="mt-6">
              <ChatInterno oportunidadeId={pedido.numero_pedido} />
            </TabsContent>
          </Tabs>
        </DialogContent>
      </Dialog>
