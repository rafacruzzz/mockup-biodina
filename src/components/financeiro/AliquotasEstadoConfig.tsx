  ...
  return (
    <div className="space-y-6">
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="text-2xl text-biodina-blue">ICMS DIFAL para não contribuinte</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="p-4 border rounded-lg bg-muted/50">
            <div className="flex items-start gap-3">
              <Checkbox 
                id="possui-icms-difal" 
                checked={possuiICMSDIFAL}
                onCheckedChange={(checked) => setPossuiICMSDIFAL(checked as boolean)}
                className="mt-1"
              />
              <Label htmlFor="possui-icms-difal" className="text-sm font-normal cursor-pointer">
                Possui ICMS DIFAL para não contribuinte em operações interestaduais (EC 87/2015)
              </Label>
            </div>
          </div>
