  ...
  return (
    <div className="w-80 bg-white border-r border-gray-200/80 overflow-y-auto shadow-sm">
      <div className="p-6 border-b border-gray-100 flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-imuv-blue mb-2">Cadastros</h2>
          ...
          <div key={key} className="space-y-1">
            ...
            >
              <div className="flex items-center gap-3">
                <div className={cn(
                  "p-2 rounded-lg",
                  activeModule === key ? 'bg-white/20' : 'bg-imuv-gold/10'
                )}>
                  <module.icon className={cn(
                    "h-5 w-5",
                    activeModule === key ? 'text-white' : 'text-imuv-gold'
                  )} />
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      activeModule === key && activeSubModule === subKey
                        ? 'bg-imuv-gold text-white shadow-sm'
