  ...
  return (
    <div className="flex items-center justify-center h-full bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="text-center max-w-md">
        <div className="w-24 h-24 bg-imuv-cyan/10 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <Package className="h-12 w-12 text-imuv-cyan" />
        </div>
        ...
        <Button 
          ...
          className="bg-imuv-cyan hover:bg-imuv-cyan/90 text-white"
        >
