...
import { X, Plus, FileText, MessageSquare, Upload, Package, Thermometer, Users, DollarSign, Eye } from 'lucide-react';
...
const OportunidadeAvancadaForm = ({ oportunidade, onClose, onSave }: OportunidadeAvancadaFormProps) => {
  ...
  const [formData, setFormData] = useState({
    ...
    situacaoLicitacao: oportunidade?.situacaoLicitacao || '',
    unidadeCompradora: oportunidade?.unidadeCompradora || '',
    portaLicitacao: oportunidade?.portaLicitacao || '',
    contatoLicitacao: oportunidade?.contatoLicitacao || '',
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="dados-gerais" className="space-y-6">
            ...
            {/* Campo Análise Técnica - Somente Leitura */}
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <div>
                  <Label htmlFor="analiseTecnicaPreview">Análise Técnica (somente visualização)</Label>
                  <Textarea
                    id="analiseTecnicaPreview"
                    value={formData.analiseTecnica}
                    readOnly={true}
                    placeholder="O conteúdo digitado na aba 'Análise Técnica' aparecerá aqui..."
                    rows={8}
                    className="w-full bg-gray-50 cursor-not-allowed"
                  />
                  <p className="text-sm text-gray-500 mt-1">
                    Para editar, acesse a aba "Análise Técnica"
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="unidadeCompradora">Unidade Compradora</Label>
                    <Input
                      id="unidadeCompradora"
                      value={formData.unidadeCompradora}
                      onChange={(e) => handleInputChange('unidadeCompradora', e.target.value)}
                      placeholder="Digite a unidade compradora"
                    />
                  </div>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="portaLicitacao">Portal da Licitação</Label>
                      <Input
                        id="portaLicitacao"
                        value={formData.portaLicitacao}
                        onChange={(e) => handleInputChange('portaLicitacao', e.target.value)}
                        placeholder="Digite o portal"
                      />
                    </div>
                    <div>
                      <Label htmlFor="contatoLicitacao">Contato</Label>
                      <Input
                        id="contatoLicitacao"
                        value={formData.contatoLicitacao}
                        onChange={(e) => handleInputChange('contatoLicitacao', e.target.value)}
                      ...
                      <TableBody>
                        {licitantes.map((licitante) => (
                          <TableRow key={licitante.id}>
                            <TableCell>
                              <Badge variant={licitante.ranking === 1 ? "default" : "secondary"}>
                                #{licitante.ranking}
                              </Badge>
                            </TableCell>
