...
export const TemplateTrainamentoExcelsior = ({
  dataRegistro = "",
  nomeInstrutor = "",
  observacoes = "",
  onChangeData,
  ...
  const topicos = [
    "Introdução ao sistema Excelsior Thermo Fisher Epredia",
    "Princípios de processamento de tecidos",
    "Preparo e manuseio de amostras histológicas",
    "Operação do equipamento e interface",
    "Protocolos de processamento padrão",
    ...
    "Documentação e rastreabilidade de amostras"
  ];
    ...
    <Card className="border-biodina-blue/20">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg">Registro de Treinamento - Excelsior Thermo Fisher Epredia</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Sistema automatizado de processamento de tecidos para histologia e anatomia patológica.
          </p>
        </div>
