...
export const TemplateTrainamentoABL90 = () => {
  const topicos = [
    "Introdução ao sistema ABL90 FLEX",
    "Técnicas de coleta de sangue arterial e venoso",
    "Interface touchscreen e navegação no menu",
    "Calibração automática e verificação",
    "Controle de qualidade interno e externo",
    "Medição de parâmetros críticos (pH, gases, lactato, glicose)",
    "Manutenção diária e semanal",
    "Identificação e resolução de alarmes",
    "Gestão de soluções de calibração e consumíveis",
    "Conectividade LIS e backup de dados"
  ];
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Sistema avançado de gasometria com interface touchscreen e conectividade aprimorada.
          </p>
        </div>
