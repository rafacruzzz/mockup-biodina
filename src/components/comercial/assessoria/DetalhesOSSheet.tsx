...
import { Calendar, MapPin, User, Briefcase, Package, FileText, Clock, ExternalLink } from "lucide-react";
...
export const DetalhesOSSheet = ({ os, isOpen, onClose }: DetalhesOSSheetProps) => {
        ...
        <ScrollArea className="h-[calc(100vh-200px)] pr-4">
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {os.equipamento && (
                  <div className="space-y-1">
                    ...
                    {os.numeroSerieLote && (
                      <p className="text-xs pl-6 text-muted-foreground">S/N: {os.numeroSerieLote}</p>
                    )}
                  </div>
                )}
                {os.projeto && (
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm pl-6 whitespace-pre-wrap">{os.descricaoServico}</p>
            </div>
            ...
            {os.servicoRealizado && (
              <div className="space-y-2">
                ...
                <p className="text-sm pl-6 whitespace-pre-wrap">{os.servicoRealizado}</p>
              </div>
            )}
            ...
            {os.observacoes && (
              <div className="space-y-2">
                ...
                <p className="text-sm pl-6 text-muted-foreground italic whitespace-pre-wrap">{os.observacoes}</p>
              </div>
            )}
