...
"ESTAS CAIXAS TÉRMICAS DE ISOPOR CONTÊM PRODUTOS CONGELADOS COM GELO SECO A -18ºC". (Dezoito graus celsius negativos)".`,
    ...
    aoTotalPages: '02',
    aoSubject: 'SHIPMENT INSTRUCTIONS,DD-xxxx/RD-xxxx, YOUR AO\'s xxx and xxx USD xxx.',
    aoCustomer: '',
    
    // SPECIFIC FIELDS (Invoice) - Instrução de Embarque (COM VALORES PADRÃO)
    aoInvoiceTitle: 'Please mention on the invoice:',
    aoPortugueseDescription: 'proforma invoice#XXXXXXX',
    aoUnitTotalPrices: '',
    aoLotEachItem: '',
