...
const SEGMENTOS_DEFAULT: SegmentoLead[] = [
  ...
  { id: '15', value: 'publico_hospital_secretaria_saude', label: 'PÚBLICO - HOSPITAL - SECRETARIA DE SAÚDE', isDefault: true },
  ...
  { id: '25', value: 'publico_laboratorio_secretaria_saude', label: 'PÚBLICO - LABORATÓRIO - SECRETARIA DE SAÚDE', isDefault: true },
