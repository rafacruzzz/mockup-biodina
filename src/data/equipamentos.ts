...
export const equipamentosMock: Equipamento[] = [
  ...
  },
  {
    id: "eq-007",
    modelo: "ABL800 FLEX",
    numeroSerie: "SN-20240789",
    lote: "LOT-2024-ABL789",
    clienteAtual: "Clínica São Camilo",
    clienteAtualId: "CON-2024-012",
    setorAlocacao: "Laboratório de Gasometria",
    responsavelCliente: "Dr. Fernando Oliveira",
    contatoTelefone: "(11) 3456-7890",
    contatoEmail: "fernando.oliveira@saocamilo.com.br",
    status: "ativo",
    dataFabricacao: new Date(2024, 5, 15),
    dataValidade: new Date(2029, 5, 15),
    dataImportacao: new Date(2024, 7, 20),
    statusOrigem: "novo",
  ...
  },
  {
    id: "eq-008",
    modelo: "DxH 520",
    numeroSerie: "SN-20241234",
    lote: "LOT-2024-DXH234",
    clienteAtual: "Clínica São Camilo",
    clienteAtualId: "CON-2024-012",
    setorAlocacao: "Laboratório de Hematologia",
    responsavelCliente: "Dra. Mariana Silva",
    contatoTelefone: "(11) 3456-7891",
    contatoEmail: "mariana.silva@saocamilo.com.br",
    status: "ativo",
    dataFabricacao: new Date(2024, 8, 10),
    dataValidade: new Date(2029, 8, 10),
    dataImportacao: new Date(2024, 10, 5),
    statusOrigem: "novo",
    versaoSoftware: "v2.8.5",
    versaoWindows: "Windows 10 Enterprise",
  },
  {
    id: "eq-009",
    modelo: "AQT 90 FLEX",
    numeroSerie: "SN-20240456",
    lote: "LOT-2024-AQT456",
    clienteAtual: "Clínica São Camilo",
    clienteAtualId: "CON-2024-012",
    setorAlocacao: "Laboratório de Análises Clínicas",
    responsavelCliente: "Dr. Carlos Mendes",
    contatoTelefone: "(11) 3456-7892",
    contatoEmail: "carlos.mendes@saocamilo.com.br",
    status: "ativo",
    dataFabricacao: new Date(2024, 4, 20),
    dataValidade: new Date(2029, 4, 20),
    dataImportacao: new Date(2024, 6, 15),
    statusOrigem: "novo",
    versaoSoftware: "v4.1.3",
    versaoWindows: "Windows 10 IoT",
  },
];
