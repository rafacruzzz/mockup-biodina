...
export const mockComissoes: Comissao[] = [
  {
    ...
    faturaRecebimento: {
      ...
      swiftIban: 'BR5600000000000720000192600C1',
      footer: 'BIODINA INSTRUMENTOS CIENTÍFICOS LTDA – CNPJ: 29.375.441/0001-50\nRUA SÃO PEDRO, NÚMERO 154, COMPLEMENTO SALA 409 CEP 24.020-058\nBAIRRO CENTRO MUNICÍPIO NITERÓI UF RJ TELEFONE (21) 2719-2419',
      swiftAnexo: ''
    },
    relatorioAgente: {
