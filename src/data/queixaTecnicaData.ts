...
export const queixaTecnicaMockada: QueixaTecnica = {
  ...
  classificacaoCodigoNivel1: '1000',
  classificacaoTermoNivel1: 'Implante, ativação',
  classificacaoDefinicaoNivel1: 'posicionamento ou separação, Problema associado com qualquer desvio do produto para a saúde - especificação documentada de desempenho, relacionadas à sequência de eventos para ativação ou posicionamento do produto para a saúde ou algum de seus componentes em uma localização específica do corpo.',
  classificacaoCodigoNivel2: '1002',
  classificacaoTermoNivel2: 'Falha para ativar',
  classificacaoDefinicaoNivel2: 'Problema associado com a incapacidade do produto para a saúde, ou seu componente, de ser ativado.',
  // Local da identificação/ocorrência
  dataIdentificacaoOcorrencia: new Date('2024-04-04'),
  localIdentificacaoOcorrencia: 'Confidencial',
  nomeEstabelecimentoSaude: 'Confidencial',
  cnesEstabelecimento: 'Confidencial',
  cnpjEstabelecimento: 'Confidencial',
  paisEstabelecimento: 'Confidencial',
  ufEstabelecimento: 'Confidencial',
  municipioEstabelecimento: 'Confidencial',
  enderecoLocalIdentificacao: 'Confidencial',
  ...
  telefoneContato: '(21) 2620-5555',
  ufFabricante: 'RIO DE JANEIRO',
  municipioFabricante: 'NITERÓI',
  nomeFabricante: 'Radiometer Medical ApS',
  paisFabricante: 'Dinamarca',
