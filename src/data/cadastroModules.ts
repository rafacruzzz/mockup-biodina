...
export const modules: ModulesConfig = {
  ...
  atualizacoes_anvisa: {
    ...
    subModules: {
      atualizacoes: {
        name: "Atualizações de Registro",
        data: [
          {
            id: 1,
            produtoId: 1,
            numeroRegistroAnvisa: "80149770001",
            dataAtualizacao: "2024-01-15",
            tipoAtualizacao: "Alteração de Fabricante",
            status: "Aprovado"
          },
          {
            id: 2,
            produtoId: 2,
            numeroRegistroAnvisa: "80149770002",
            dataAtualizacao: "2024-02-20",
            tipoAtualizacao: "Renovação de Registro",
            status: "Em Análise"
          }
        ]
      }
  ...
  registros_anvisa: {
    ...
    subModules: {
      registros: {
        name: "Registros de Produtos",
        data: [
          {
            id: 1,
            produtoSelecionado: {
              id: 1,
              nome: "Analisador Hematológico DxH 520",
              codigo: "DXH520",
              descricao: "Sistema automatizado para análise hematológica",
              marca: "Beckman Coulter",
              familiaProduto: "Equipamentos",
              areaAnvisa: "diagnostico_in_vitro"
            },
            numeroProcessoAnvisa: "25351.123456/2024-01",
            nomeArquivaPrincipal: "DXH520_Registro_Principal.pdf",
            status: "aprovado",
            areaAnvisa: "diagnostico_in_vitro",
          ...
          },
          {
            ...
            produtoSelecionado: {
              id: 2,
              nome: "Analisador de Gasometria ABL800",
              codigo: "ABL800",
              descricao: "Sistema para análise de gases sanguíneos",
              marca: "Radiometer",
              familiaProduto: "Equipamentos",
              areaAnvisa: "diagnostico_in_vitro"
            },
            numeroProcessoAnvisa: "25351.234567/2024-02",
            nomeArquivaPrincipal: "ABL800_Registro_Principal.pdf",
  ...
  due_diligence_fornecedor: {
    ...
    subModules: {
      triagens: {
        name: "Triagens de Fornecedores",
        data: [
          {
            id: 1,
            idTriagem: "TRI-2024-001",
            nomeFornecedor: "MedTech Distribuidora Ltda",
            dataCriacao: "2024-01-10",
            statusAtual: "Em Análise Preliminar",
            responsavel: "João Silva",
            contatoPrincipal: "Maria Santos",
            emailContato: "maria@medtech.com.br",
            telefoneContato: "(11) 3456-7890",
            produtosInteresse: "Equipamentos de diagnóstico",
            protocoloInterno: "DD-2024-001"
          },
          {
            id: 2,
            idTriagem: "TRI-2024-002",
            nomeFornecedor: "BioSupply International",
            dataCriacao: "2024-01-25",
            statusAtual: "Aguardando Documentos",
            responsavel: "Ana Costa",
            contatoPrincipal: "Robert Johnson",
            emailContato: "robert@biosupply.com",
            telefoneContato: "+1 555-1234",
            produtosInteresse: "Reagentes para laboratório",
            protocoloInterno: "DD-2024-002"
          },
          {
            id: 3,
            idTriagem: "TRI-2024-003",
            nomeFornecedor: "Pharma Solutions Brasil",
            dataCriacao: "2024-02-05",
            statusAtual: "Aprovado",
            responsavel: "Carlos Mendes",
            contatoPrincipal: "Paula Oliveira",
            emailContato: "paula@pharmasolutions.com.br",
            telefoneContato: "(21) 2345-6789",
            produtosInteresse: "Insumos farmacêuticos",
            protocoloInterno: "DD-2024-003"
          }
        ]
      }
    }
