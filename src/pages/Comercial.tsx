      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        >
          <CardContent className="p-8 text-center">
            <ShoppingCart className="h-16 w-16 text-imuv-blue mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-imuv-blue mb-2">Vendas</h3>
        ...
        >
          <CardContent className="p-8 text-center">
            <HandCoins className="h-16 w-16 text-imuv-blue mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-imuv-blue mb-2">Empréstimos</h3>
        ...
        >
          <CardContent className="p-8 text-center">
            <Target className="h-16 w-16 text-imuv-blue mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-imuv-blue mb-2">Assessoria Científica</h3>
        ...
        >
          <CardContent className="p-8 text-center">
            <FileText className="h-16 w-16 text-imuv-blue mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-imuv-blue mb-2">Departamento Técnico</h3>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-imuv-blue">Comercial / Assessoria Científica</h2>
    ...
    return (
      <div className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-imuv-blue">Comercial / Vendas</h1>
        </div>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 py-2 px-1 border-b-2 font-medium text-sm transition-colors ${
                  activeTab === tab.id
                    ? 'border-imuv-blue text-imuv-blue'
