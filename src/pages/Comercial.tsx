...
const Comercial = () => {
  ...
  const [todasOportunidades, setTodasOportunidades] = useState<any[]>([
    ...
    // EXEMPLO: Licitação SEM empresa participante - para testar seleção
    {
      ...
      responsavel: 'João Silva',
      origem: 'Portal de Licitações',
      familiaComercial: 'Equipamentos GPS',
      situacao: 'em_acompanhamento',
      status: 'Em Acompanhamento',
      resultadoOportunidade: 'em_andamento',
      tipoAplicacao: 'venda',
      ...
      dataContato: '16/02/2025',
      termometro: 70,
      fonteLead: 'Licitação',
      segmento: 'Municipal',
      modalidade: 'licitacao',
      descricao: 'Aquisição de equipamentos de georreferenciamento para cadastro rural. SEM EMPRESA ATRELADA - use para testar seleção de empresa.',
      produtos: ['Receptor GNSS', 'Controlador de Campo'],
      servicos: ['Instalação', 'Treinamento']
    },
    // EXEMPLO: Licitação COM empresa aguardando aprovação - para testar modal de aprovação
    {
      ...
      responsavel: 'Maria Santos',
      origem: 'Portal ComprasNet',
      familiaComercial: 'Drones e Sensores',
      situacao: 'em_acompanhamento',
      status: 'Em Acompanhamento',
      resultadoOportunidade: 'em_andamento',
      tipoAplicacao: 'venda',
      ...
      dataContato: '02/03/2025',
      termometro: 85,
      fonteLead: 'Licitação',
      segmento: 'Federal',
      modalidade: 'licitacao',
      descricao: 'Sistema de monitoramento de lavouras via satélite e drones. COM EMPRESA AGUARDANDO APROVAÇÃO - use para testar aprovação gerencial.',
      produtos: ['Drone DJI Agras', 'Câmera Multiespectral', 'Software Processamento'],
      ...
      <div className="space-y-6">
        ...
        <div className="border-b">
          <div className="flex gap-4">
            ...
            <button onClick={() => setAssessoriaTab("chamados")} className={`px-4 py-2 border-b-2 transition-colors ${assessoriaTab === "chamados" ? "border-primary text-primary font-medium" : "border-transparent text-muted-foreground hover:text-foreground"}`}>Chamados</button>
      ...
      <div className="space-y-6">
        ...
        <div className="border-b">
          <div className="flex gap-4">
            ...
            <button onClick={() => setDepartamentoTecnicoTab("chamados")} className={`px-4 py-2 border-b-2 transition-colors ${departamentoTecnicoTab === "chamados" ? "border-primary text-primary font-medium" : "border-transparent text-muted-foreground hover:text-foreground"}`}>Chamados</button>
